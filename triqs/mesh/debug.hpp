...
namespace triqs::mesh {
  ...
  template <typename MP, typename T> bool mesh_point_compatible_to_mesh(MP const &mp, T const &m) { return mp.mesh() == m; }
  ...
  template <typename... M>
  bool mesh_point_compatible_to_mesh(mesh_point<cartesian_product<M...>> const &mp, cartesian_product<M...> const &m) {
