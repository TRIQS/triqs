...
namespace triqs {
  namespace arrays {
    ...
    // make_shape
    template <typename... T> mini_vector<size_t, sizeof...(T)> make_shape(T... args) { return mini_vector<size_t, sizeof...(T)>(args...); }
    ...
    namespace indexmaps {
      ...
      template <typename IndexMap1, typename IndexMap2> bool compatible_for_binary_ops(const IndexMap1 &, const IndexMap2 &);
  ...
  */
      template <typename IndexMap1, typename IndexMap2> bool raw_copy_possible(const IndexMap1 &, const IndexMap2 &);
