  ...
  namespace arrays {
    namespace blas {
      ...
      namespace f77 {
        ...
        extern "C" {
        void TRIQS_FORTRAN_MANGLING(dgtsv)(const int &N, const int &NRHS, double DL[], double D[], double DU[], double B[], const int &LDB,
                                           int &info);
        void TRIQS_FORTRAN_MANGLING(zgtsv)(const int &N, const int &NRHS, dcomplex DL[], dcomplex D[], dcomplex DU[], dcomplex B[], const int &LDB,
                                           int &info);
        }
      ...
      std14::enable_if_t<is_blas_lapack_type<typename MT::value_type>::value && is_blas_lapack_type<typename VT::value_type>::value
