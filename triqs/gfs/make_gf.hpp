...
namespace triqs {
  namespace gfs {
    ...
    gf<Var, typename T::target_t> make_gf(gf_mesh<Var> m, T const &t, memory_layout<R> const &ml) {
    ...
    template <typename G> typename G::regular_type make_gf(G const &g, typename G::memory_layout_t const &ml) {
