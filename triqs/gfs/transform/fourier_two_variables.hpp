...
namespace triqs {
 ...
 #. Fourier transform from  $g_{uvw}(i\omega,\tau')$ to  $g_{uvw}(i\omega,i\Omega)$
  ...
  gf<cartesian_product<imfreq, imfreq>, tensor_valued<3>>
      fourier(gf_const_view<cartesian_product<imtime, imtime>, tensor_valued<3>> g2t, int n_w_1, int n_w_2,
              bool positive_matsub_only_1 = true, bool positive_matsub_only_2 = true);
 ...
 @warning fitting the tails!
  ...
  gf<cartesian_product<imtime, imtime>, tensor_valued<3>>
      inverse_fourier(gf_const_view<cartesian_product<imfreq, imfreq>, tensor_valued<3>> g2w, int n_t_1, int n_t_2,
                      bool fit_tails = false);
 }
}
