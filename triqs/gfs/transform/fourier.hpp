...
namespace triqs::gfs {
  ...
  *-----------------------------------------------------------------------------------------------------*/
  ...
  auto make_gf_from_fourier(G const &gin, M const &m, std::vector<array<dcomplex, R>> const &known_moments) REQUIRES(is_block_gf<G>::value) {
  ...
  auto make_gf_from_fourier(G const &gin, Args const &... args) REQUIRES(is_block_gf<G>::value) {
