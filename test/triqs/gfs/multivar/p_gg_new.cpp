...
gf_bz_imfreq_mat compute_gg_fft(gf_bz_imfreq_mat const &G_k_w) {
  ...
  auto chi0_q_tau = gf<cartesian_product<b_zone, imtime>, matrix_valued>{{k_mesh, {beta, Boson, ntau}}, {1, 1}};
  auto chi0_R_tau = gf<cartesian_product<cyclic_lattice, imtime>, matrix_valued>{{{nk, nk}, {beta, Boson, ntau}}, {1, 1}};
  auto G_k_tau    = gf<cartesian_product<b_zone, imtime>, matrix_valued>{{k_mesh, {beta, Fermion, ntau}}, {1, 1}};
