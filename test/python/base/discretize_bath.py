...
from triqs.gfs.tools import discretize_bath, make_delta
from triqs.utility.comparison_tests import assert_gfs_are_close

# build delta from discretized values
mesh = MeshImFreq(beta=40, statistic='Fermion', n_iw=200)
...
mesh = MeshImTime(beta=40, statistic='Fermion', n_tau=1001)
...
#################################################
# test blockGf
mesh = MeshImTime(beta=40, statistic='Fermion', n_tau=501)
