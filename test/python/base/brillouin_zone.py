...
class test_brillouin_zone(unittest.TestCase):
    ...
    def test_mesh_construction(self):
        ...
        per_mat = array([[16, 0, 0],[0, 16, 0],[0, 0, 1]], dtype=int32)
        run(units, per_mat)

        # ---- triangular lattice : 6 x 6 x 1
        units = array([[1.,0.,0.],[0.5,sqrt(3)/2.,0.],[0.,0.,1.]])
        per_mat = array([[6, 0, 0],[0, 6, 0],[0, 0, 1]], dtype=int32)
        run(units, per_mat)
    ...
    def test_interpolate(self):
        ...
        n_k = 40
        per_mat = array([[n_k, 0, 0],[0, n_k, 0],[0, 0, 1]], dtype=int32)
        k_mesh  = MeshBrZone(bz, per_mat)
        ...
        n_k_fine = 5 * n_k
        per_mat = array([[n_k_fine, 0, 0],[0, n_k_fine, 0], [0, 0, 1]], dtype=int32)
