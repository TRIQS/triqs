...
#
# Authors: Henri Menke, Nils Wentzell
...
class test_tail_issues(unittest.TestCase):
    ...
    def test_delta_infty(self):
        ...
        d << C - tail[0]
        tail[0] = 0.
        tau_mesh = MeshImTime(beta = 1, statistic = "Fermion", n_tau = 2001)
        ...
        # Check Delta(iw) extracted through triqs.gfs.tools.delta
        D_exact = g.copy()
