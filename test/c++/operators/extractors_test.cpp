...
TEST(Extractors, extract_h_dict) {
  auto h0  = eps1 * (n("up", 1) + n("dn", 1)) + eps2 * (n("up", 2) + n("dn", 2)) + eps3 * (n("up", 3) + n("dn", 3));
  auto hop = t12 * (c_dag("up", 1) * c("up", 2) + c_dag("dn", 1) * c("dn", 2)) + t23 * (c_dag("up", 2) * c("up", 3) + c_dag("dn", 2) * c("dn", 3))
     + t31 * (c_dag("up", 3) * c("up", 1) + c_dag("dn", 3) * c("dn", 1));
  h0 += hop + dagger(hop);

  array<double, 2> h_matrix_ref{{eps1, t12, t31, .0, .0, .0}, {t12, eps2, t23, .0, .0, .0}, {t31, t23, eps3, .0, .0, .0},
                                {.0, .0, .0, eps1, t12, t31}, {.0, .0, .0, t12, eps2, t23}, {.0, .0, .0, t31, t23, eps3}};
...
TEST(Extractors, extract_U_dict2) {
  auto h_int = U1 * n("up", 1) * n("dn", 1) + U2 * n("up", 2) * n("dn", 2) + U3 * n("up", 3) * n("dn", 3);
  auto N1    = n("up", 1) + n("dn", 1);
  auto N2    = n("up", 2) + n("dn", 2);
  auto N3    = n("up", 3) + n("dn", 3);
  h_int += V12 * N1 * N2 + V23 * N2 * N3 + V31 * N1 * N3;

  array<double, 2> U_matrix2_ref{{.0, V12, V31, U1, V12, V31}, {V12, .0, V23, V12, U2, V23}, {V31, V23, .0, V31, V23, U3},
                                 {U1, V12, V31, .0, V12, V31}, {V12, U2, V23, V12, .0, V23}, {V31, V23, U3, V31, V23, .0}};
