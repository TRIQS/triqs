...
TEST(SuperLatticeTest, 2x2SquareLattice3d_with_gloc) {
  ...
  auto opt1 = bz_int_options{.k_grid = {10, 10, 5}, .k_grid_max = {10, 10, 5}, .run_adaptive = false};
  auto opt2 = bz_int_options{.k_grid = {5, 5, 5}, .k_grid_max = {5, 5, 5}, .run_adaptive = false};
