...
// --------- class _c2py_cls_0 -----------
using _c2py_cls_0                                            = triqs::experimental::lattice::bz_int_options;
template <> constexpr bool c2py::is_wrapped<_c2py_cls_0>     = true;
template <> inline constexpr auto c2py::tp_name<_c2py_cls_0> = "triqs.experimental.lattice.lattice.BzIntOptions";
...
constexpr auto _c2py_doc_member_2 = R"DOC(default PTR number of points)DOC";
constexpr auto _c2py_doc_member_3 = R"DOC(Increase step of k in the grid refinement)DOC";
constexpr auto _c2py_doc_member_4 = R"DOC(Max of kx, ky, kz)DOC";
constexpr auto _c2py_doc_member_5 = R"DOC(if false, does not run adaptive integration at the end)DOC";
constexpr auto _c2py_doc_member_6 = R"DOC(if false, does not run PTR integration, goes directly to adaptive)DOC";
...
constinit PyGetSetDef c2py::tp_getset<_c2py_cls_0>[] = {
   ...
   c2py::getsetdef_from_member<&_c2py_cls_0::k_grid, _c2py_cls_0>("k_grid", _c2py_doc_member_1),
   c2py::getsetdef_from_member<&_c2py_cls_0::delta_k_grid, _c2py_cls_0>("delta_k_grid", _c2py_doc_member_2),
   c2py::getsetdef_from_member<&_c2py_cls_0::k_grid_max, _c2py_cls_0>("k_grid_max", _c2py_doc_member_3),
   c2py::getsetdef_from_member<&_c2py_cls_0::run_adaptive, _c2py_cls_0>("run_adaptive", _c2py_doc_member_4),
   c2py::getsetdef_from_member<&_c2py_cls_0::run_ptr, _c2py_cls_0>("run_ptr", _c2py_doc_member_5),
   c2py::getsetdef_from_member<&_c2py_cls_0::verbose, _c2py_cls_0>("verbose", _c2py_doc_member_6),
   {"__dict__", (getter)prop_get_dict_0, nullptr, "", nullptr},
   {nullptr, nullptr, nullptr, nullptr, nullptr}};

template <>
const std::string c2py::tp_doc<_c2py_cls_0> = R"DOC(Options for the case of integrate_bz function, with both adaptive + ptr integration
...
// --------- class _c2py_cls_1 -----------
using _c2py_cls_1                                            = triqs::experimental::lattice::superlattice;
template <> constexpr bool c2py::is_wrapped<_c2py_cls_1>     = true;
template <> inline constexpr auto c2py::tp_name<_c2py_cls_1> = "triqs.experimental.lattice.lattice.Superlattice";
static const auto _c2py_init_0                               = c2py::dispatcher_c_kw_t{c2py::c_constructor<
   _c2py_cls_1, nda::basic_array<long, 2, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>>,
...
template <>
const std::string c2py::tp_doc<_c2py_cls_1> = R"DOC(Representation of a superlattice for a lattice.

Defined by the unit vectors of the superlattice and a set of cluster points.)DOC"
   + std::string{"\n\n----------\n\n"} + c2py::tp_ctor_doc<_c2py_cls_1>;
// --------- class _c2py_cls_2 -----------
using _c2py_cls_2                                            = triqs::experimental::lattice::tb_hk;
template <> constexpr bool c2py::is_wrapped<_c2py_cls_2>     = true;
template <> inline constexpr auto c2py::tp_name<_c2py_cls_2> = "triqs.experimental.lattice.lattice.TbHk";
static const auto _c2py_init_1                               = c2py::dispatcher_c_kw_t{
   c2py::c_constructor<_c2py_cls_2, std::vector<std::array<long, 3>>,
   ...
   c2py::c_constructor<_c2py_cls_2>()};
...
static auto const _c2py_fun_0 = c2py::dispatcher_f_kw_t{
   c2py::cmethod(
      ...
      "self", "k_list"),
   c2py::cmethod([](_c2py_cls_2 const &self, std::array<double, 3> ks) -> decltype(auto) { return self.operator()(ks); }, "self", "ks")};

template <> inline constexpr ternaryfunc c2py::tp_call<_c2py_cls_2> = c2py::pyfkw<_c2py_fun_0>;

// eigenvalues
static auto const _c2py_fun_1 = c2py::dispatcher_f_kw_t{
   c2py::cmethod([](_c2py_cls_2 const &self,
...
static auto const _c2py_fun_3 = c2py::dispatcher_f_kw_t{
   c2py::cmethod([](_c2py_cls_2 const &self, std::array<long, 3> R) -> decltype(auto) { return self.get_R_idx(R); }, "self", "R")};
...
static constexpr auto prop_doc_3 = R"DOC(Lazy range of 2D views into the packed coefficient array, one per R-vector.)DOC";
static constexpr auto prop_doc_4 = R"DOC(Number of R-vectors)DOC";
static constexpr auto prop_doc_5 = R"DOC(Provide number of orbitals (the dimension of the stored Hamiltonian))DOC";
...
constinit PyGetSetDef c2py::tp_getset<_c2py_cls_2>[] = {
   ...
   {"hoppings", c2py::getter_from_method<c2py::castmc<>(&triqs::experimental::lattice::tb_hk::hoppings)>, nullptr, prop_doc_3, nullptr},
   {"n_R",
    ...
    nullptr, prop_doc_4, nullptr},
   {"n_orbitals", c2py::getter_from_method<c2py::castmc<>(&triqs::experimental::lattice::tb_hk::n_orbitals)>, nullptr, prop_doc_5, nullptr},
   {nullptr, nullptr, nullptr, nullptr, nullptr}};
...
[1, 2] Compute the non-interacting local Green's function on a given mesh from a tight binding Hamiltonian

------

[3, 4] Compute local Green's function on a given mesh from a tight binding Hamiltonian

------

[5, 6] Compute local Green's function on a given mesh as a block GF, from a tight binding Hamiltonian
...
#define _add_type(T, N) c2py::add_type_object_to_main<T>(N, m, conv_table)
  _add_type(_c2py_cls_0, "BzIntOptions");
  _add_type(_c2py_cls_1, "Superlattice");
  _add_type(_c2py_cls_2, "TbHk");
#undef _add_type
