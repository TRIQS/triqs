...
static struct PyModuleDef module_def = {
   ...
   R"RAWDOC(Internal ``CallProxy`` dispatchers that implement ``Gf.__call__`` for target rank 2. Not intended for direct use.)RAWDOC", /* module documentation, may be NULL */
