...
# They are automatically registered as member functions of the Gf class in the pytriqs/gf/gf.py file
...
for gf_type in ["gf", "block_gf", "block2_gf"]:
    ...
    m.add_function("bool is_gf_hermitian(%s<imfreq, tensor_valued<4>> g, double tolerance = 1.e-13)"%gf_type)

    # is_gf_hermitian imtime
    m.add_function("bool is_gf_hermitian(%s<imtime, scalar_valued> g, double tolerance = 1.e-13)"%gf_type)
    m.add_function("bool is_gf_hermitian(%s<imtime, matrix_valued> g, double tolerance = 1.e-13)"%gf_type)
    m.add_function("bool is_gf_hermitian(%s<imtime, tensor_valued<4>> g, double tolerance = 1.e-13)"%gf_type)
