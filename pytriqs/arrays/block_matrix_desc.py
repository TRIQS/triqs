...
# c++2py.py ../c++/block_matrix.hpp -p -m triqs.arrays.block_matrix -o block_matrix
from cpp2py.wrap_generator import *

# The module
module = module_(full_name = "triqs.arrays.block_matrix", doc = "Block-diagonal matrix containers")
