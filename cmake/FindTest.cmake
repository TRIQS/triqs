SET(PythonBuildExecutable ${PYTHON_EXECUTABLE})
...
macro(add_python_test testname)
 ...
 set_property(TEST py_${testname} PROPERTY ENVIRONMENT PYTHONPATH=${CMAKE_BINARY_DIR}/python:${CPP2PY_BINARY_DIR}:${NDA_BINARY_DIR}/python:${H5_BINARY_DIR}/python:./:$ENV{PYTHONPATH})
