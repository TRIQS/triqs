...
macro (triqs_python_extension ModuleName)
 ...
 add_custom_command(OUTPUT ${wrap_name} ${converter_name} DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${ModuleName}_desc.py
  COMMAND PYTHONPATH=${CMAKE_BINARY_DIR}/pytriqs/c++2py:${CMAKE_BINARY_DIR}/ ${PYTHON_INTERPRETER} ${CMAKE_CURRENT_BINARY_DIR}/${ModuleName}_desc.py
   ${CMAKE_SOURCE_DIR}/pytriqs/c++2py/mako/xxx_wrap.cpp
   ${wrap_name}
   ${CMAKE_SOURCE_DIR}/pytriqs/c++2py/mako/py_converter.hpp
   ${converter_name} 
