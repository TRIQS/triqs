...
namespace triqs {
   ...
   */
    ...
    gfs::gf<Mesh, gfs::matrix_valued> gloc(Mesh const &w_mesh, tb::tb_hamiltonian const &H_k, double mu, triqs::lattice::bz_int_options const &opt) {
  ...
  */
  ...
  G gloc(tb_hamiltonian const &H_k, double mu, G const &Sigma, lattice::bz_int_options const &opt) {
    ...
    template gfs::gf<mesh::imfreq, gfs::matrix_valued>
    gloc(tb::tb_hamiltonian const &H_k, double mu, gfs::gf<mesh::imfreq, gfs::matrix_valued> const &Sigma, lattice::bz_int_options const &opt);

    template gfs::gf<mesh::refreq, gfs::matrix_valued>
    gloc(tb::tb_hamiltonian const &H_k, double mu, gfs::gf<mesh::refreq, gfs::matrix_valued> const &Sigma, lattice::bz_int_options const &opt);
