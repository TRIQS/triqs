...
namespace triqs::experimental::lattice {
  ...
  // --------------------------------------------------
  /**
   * @brief Representation of a superlattice for a lattice.
   *
  ...
  class superlattice {
    ...
    public:
    /**
     * @brief Constructor for a superlattice
     *
   ...
   * @param fp Fourier polynomial for a lattice
   * @return Folded fourier_polynomial for the superlattice
   */
