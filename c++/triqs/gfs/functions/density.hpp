...
/**
 * @file
 * @brief Provides functions to compute the density (occupation) from Green's functions.
 */
...
namespace nda::clef {
  // Make density usable inside lazy CLEF expressions.
