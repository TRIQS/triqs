...
//
// Authors: Philipp Dumitrescu, Igor Krivenko, Nils Wentzell
...
namespace triqs::stat {
  ...
  histogram::histogram(int a, int b) : a_(a), b_(b), data_(nda::vector<double>::zeros(std::max(b - a + 1, 0))) { initialize(); }
