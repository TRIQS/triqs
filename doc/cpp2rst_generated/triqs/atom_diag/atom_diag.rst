...
| Member type                | Comment                                                                                  |
+============================+==========================================================================================+
| scalar_t                   | /// Type of matrix elements (double/dcomplex)                                            |
+----------------------------+------------------------------------------------------------------------------------------+
| matrix_t                   | /// Matrix type                                                                          |
+----------------------------+------------------------------------------------------------------------------------------+
| block_matrix_t             | /// Block-diagonal matrix type                                                           |
+----------------------------+------------------------------------------------------------------------------------------+
| full_hilbert_space_state_t | /// State vector in the full Hilbert space, written in the eigenbasis of :math:`\hat H`. |
+----------------------------+------------------------------------------------------------------------------------------+
| many_body_op_t             | /// Many-body operator type used by this atom_diag specialization.                       |
+----------------------------+------------------------------------------------------------------------------------------+
...
+------------------------------------------------------+---------+
| :ref:`operator<< <atom_diag_operator\<\<>`           |         |
+------------------------------------------------------+---------+
