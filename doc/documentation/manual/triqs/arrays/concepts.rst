...
it is expected that a(i,j) returns an int or a documentation/manual/triqs to an int, for i,j integers in some domain.
...
object returns a documentation/manual/triqs, e.g. a(i,j) can return a int &. Typically this is 
