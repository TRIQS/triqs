...
from triqs.plot.mpl_interface import subplots, oplot
f, (t,b) = subplots( 2,1)

#plot ...
oplot(g.real, '-o', x_window = (0,10), axes=t)
oplot(g.imag, '-x', x_window = (0,12), axes=b)
oplot(lambda om : -om*0.8/(om*om + 4), name = "Bad Fit !", axes=b)
