...
For more information about the workings of the Monte-Carlo worker, we refer the reader to the :doc:`documentation/manual/triqs <../monte_carlo/contents>`.

.. literalinclude:: ising2d.cpp
