...
**Synopsis**
 ...
 .. rst-class:: cppsynopsis
    ...
    1. | :cppbrief:`Access to individual amplitudes`
       | state<type-parameter-0-0, type-parameter-0-1, true>::value_type & :red:`operator()` (int :param:`i`)

    2. | :cppbrief:`Access to individual amplitudes`
       | state<type-parameter-0-0, type-parameter-0-1, true>::value_type const & :red:`operator()` (int :param:`i`) const
