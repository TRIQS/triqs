...
**Synopsis**
 ...
 .. rst-class:: cppsynopsis
    ...
    1. | :cppbrief:`pass a index_t of the mesh`
       | decltype(auto) :red:`operator[]` (gf_view::mesh_index_t const & :param:`arg`)

    2. | decltype(auto) :red:`operator[]` (gf_view::mesh_index_t const & :param:`arg`) const

    3. | :cppbrief:`pass a mesh_point of the mesh`
       | decltype(auto) :red:`operator[]` (gf_view::mesh_point_t const & :param:`x`)

    4. | decltype(auto) :red:`operator[]` (gf_view::mesh_point_t const & :param:`x`) const
    ...
    10. | :cppbrief:`------------- [] with lazy arguments -----------------------------`
        ...
        | clef::make_expr_subscript_t<gf_view<Var, Target> const &, Arg> :red:`operator[]` (Arg && :param:`arg`) const &

    11. | :green:`template<typename Arg>`
        | clef::make_expr_subscript_t<gf_view<Var, Target> &, Arg> :red:`operator[]` (Arg && :param:`arg`) &
