...
| :ref:`operator[] <triqs__gfs__block_gf_const_view__operator[]>`     |  |
+---------------------------------------------------------------------+--+
| :ref:`hdf5_scheme <triqs__gfs__block_gf_const_view__hdf5_scheme>`   |  |
+---------------------------------------------------------------------+--+
| :ref:`serialize <triqs__gfs__block_gf_const_view__serialize>`       |  |
+---------------------------------------------------------------------+--+
| :ref:`begin <triqs__gfs__block_gf_const_view__begin>`               |  |
+---------------------------------------------------------------------+--+
...
+---------------------------------------------------------------------+--+
| :ref:`boost <triqs__gfs__block_gf_const_view__boost>`               |  |
+---------------------------------------------------------------------+--+
