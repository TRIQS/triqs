 ...
 **1)**   Make a block const_view from the G. Indices are '0', '1', '2', ....



 **2)**   Create block_gf_const_view from vector of views



 **3)**   Create block_gf_const_view from block_names and vector of views