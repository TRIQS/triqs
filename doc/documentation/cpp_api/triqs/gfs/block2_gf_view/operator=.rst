...
.. _triqs__gfs__block2_gf_view__operator=:
...
**Synopsis**
 ...
 .. rst-class:: cppsynopsis
    ...
    2. | void :red:`operator=` (:ref:`mpi_lazy\<tag::reduce, block2_gf_view\<Var, Target\>::const_view_type\> <triqs__gfs__mpi_lazy>` :param:`l`)
    ...
    4. | block2_gf_view<Var, Target> & :red:`operator=` (block2_gf_view<Var, Target> const & :param:`rhs`)
