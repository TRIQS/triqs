...
.. _triqs__gfs__gf_const_view__operator[]:
...
**Synopsis**
 ...
 .. rst-class:: cppsynopsis
    ...
    1. | decltype(auto) :red:`operator[]` (gf_const_view::mesh_index_t const & :param:`arg`)

    2. | decltype(auto) :red:`operator[]` (gf_const_view::mesh_point_t const & :param:`x`)
