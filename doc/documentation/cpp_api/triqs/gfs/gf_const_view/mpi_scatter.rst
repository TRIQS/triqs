...
**Synopsis**
 ...
 .. rst-class:: cppsynopsis
    ...
    1. | :cppbrief:`Initiate (lazy) MPI Scatter`
       | :ref:`mpi_lazy\<tag::scatter, gf_const_view::const_view_type\> <triqs__gfs__mpi_lazy>` :red:`mpi_scatter` (gf_const_view<Var, Target> const & :param:`a`,
