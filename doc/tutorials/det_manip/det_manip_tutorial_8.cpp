...
int main() {
  ...
  std::cout << "We want to change a line and a column." << std::endl;
  D.change_one_line_and_one_col(0,1, 2.1, 1.2);
  std::cout << "After change_one_line_and_one_col(0,1, 2.1, 1.2), D.matrix()=" << D.matrix() << std::endl << std::endl;
  ...
  std::cout << "We want to change a line and a column." << std::endl;
  D2.change_one_line_and_one_col(0, 1, 2.1, 1.2);
  std::cout << "After change_one_line_and_one_col(0,1, 2.1, 1.2), D2.matrix()=" << D2.matrix() << std::endl << std::endl;
